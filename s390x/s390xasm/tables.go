...
var instFormats = [...]instFormat{
	...
	{AXTRA, 0xffff000000000000, 0xb3da000000000000, // ADD (extended DFP) (AXTRA R1,R2,R3,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_FPReg_16_19, ap_Mask_20_23}},
	{ADB, 0xff00000000ff0000, 0xed000000001a0000, // ADD (long BFP) (ADB R1,D2(X2,B2))
	...
	{ADTR, 0xffff000000000000, 0xb3d2000000000000, // ADD (long DFP) (ADTR R1,R2,R3)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_FPReg_16_19}},
	{ADTRA, 0xffff000000000000, 0xb3d2000000000000, // ADD (long DFP) (ADTRA R1,R2,R3,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_FPReg_16_19, ap_Mask_20_23}},
	{AEB, 0xff00000000ff0000, 0xed000000000a0000, // ADD (short BFP) (AEB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{NGRK, 0xffff000000000000, 0xb9e4000000000000, // AND (64) (NGRK R1,R2,R3)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31, ap_Reg_16_19}},
	{NC, 0xff00000000000000, 0xd400000000000000, // AND (character) (NC D1(L1,B1),D2(B2))
	...
	{BCR, 0xff00000000000000, 0x700000000000000, // BRANCH ON CONDITION (BCR M1,R2)
	...
	{CXR, 0xffff000000000000, 0xb369000000000000, // COMPARE (extended HFP) (CXR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{CDB, 0xff00000000ff0000, 0xed00000000190000, // COMPARE (long BFP) (CDB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{CDR, 0xff00000000000000, 0x2900000000000000, // COMPARE (long HFP) (CDR R1,R2)
		[8]*argField{ap_FPReg_8_11, ap_FPReg_12_15}},
	{CEB, 0xff00000000ff0000, 0xed00000000090000, // COMPARE (short BFP) (CEB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{CRDTE, 0xffff000000000000, 0xb98f000000000000, // COMPARE AND REPLACE DAT TABLE ENTRY (CRDTE R1,R3,R2,M4)
	...
	{KXTR, 0xffff000000000000, 0xb3e8000000000000, // COMPARE AND SIGNAL (extended DFP) (KXTR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{KDB, 0xff00000000ff0000, 0xed00000000180000, // COMPARE AND SIGNAL (long BFP) (KDB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{KDTR, 0xffff000000000000, 0xb3e0000000000000, // COMPARE AND SIGNAL (long DFP) (KDTR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{KEB, 0xff00000000ff0000, 0xed00000000080000, // COMPARE AND SIGNAL (short BFP) (KEB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{CLGFR, 0xffff000000000000, 0xb931000000000000, // COMPARE LOGICAL (64→32) (CLGFR R1,R2)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31}},
	{CLC, 0xff00000000000000, 0xd500000000000000, // COMPARE LOGICAL (character) (CLC D1(L1,B1),D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_15, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	...
	{CXFBRA, 0xffff000000000000, 0xb396000000000000, // CONVERT FROM FIXED (32 to extended BFP) (CXFBRA R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_Reg_28_31, ap_Mask_20_23}},
	{CXFTR, 0xffff000000000000, 0xb959000000000000, // CONVERT FROM FIXED (32 to extended DFP) (CXFTR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_Reg_28_31, ap_Mask_20_23}},
	...
	{CDFBR, 0xffff000000000000, 0xb395000000000000, // CONVERT FROM FIXED (32 to long BFP) (CDFBR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_Reg_28_31}},
	{CDFBRA, 0xffff000000000000, 0xb395000000000000, // CONVERT FROM FIXED (32 to long BFP) (CDFBRA R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_Reg_28_31, ap_Mask_20_23}},
	{CDFTR, 0xffff000000000000, 0xb951000000000000, // CONVERT FROM FIXED (32 to long DFP) (CDFTR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_Reg_28_31, ap_Mask_20_23}},
	...
	{CEFBR, 0xffff000000000000, 0xb394000000000000, // CONVERT FROM FIXED (32 to short BFP) (CEFBR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_Reg_28_31}},
	{CEFBRA, 0xffff000000000000, 0xb394000000000000, // CONVERT FROM FIXED (32 to short BFP) (CEFBRA R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_Reg_28_31, ap_Mask_20_23}},
	...
	{CXGBR, 0xffff000000000000, 0xb3a6000000000000, // CONVERT FROM FIXED (64 to extended BFP) (CXGBR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_Reg_28_31}},
	{CXGBRA, 0xffff000000000000, 0xb3a6000000000000, // CONVERT FROM FIXED (64 to extended BFP) (CXGBRA R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_Reg_28_31, ap_Mask_20_23}},
	{CXGTR, 0xffff000000000000, 0xb3f9000000000000, // CONVERT FROM FIXED (64 to extended DFP) (CXGTR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_Reg_28_31}},
	{CXGTRA, 0xffff000000000000, 0xb3f9000000000000, // CONVERT FROM FIXED (64 to extended DFP) (CXGTRA R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_Reg_28_31, ap_Mask_20_23}},
	...
	{CDGBR, 0xffff000000000000, 0xb3a5000000000000, // CONVERT FROM FIXED (64 to long BFP) (CDGBR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_Reg_28_31}},
	{CDGBRA, 0xffff000000000000, 0xb3a5000000000000, // CONVERT FROM FIXED (64 to long BFP) (CDGBRA R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_Reg_28_31, ap_Mask_20_23}},
	{CDGTR, 0xffff000000000000, 0xb3f1000000000000, // CONVERT FROM FIXED (64 to long DFP) (CDGTR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_Reg_28_31}},
	{CDGTRA, 0xffff000000000000, 0xb3f1000000000000, // CONVERT FROM FIXED (64 to long DFP) (CDGTRA R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_Reg_28_31, ap_Mask_20_23}},
	...
	{CEGBR, 0xffff000000000000, 0xb3a4000000000000, // CONVERT FROM FIXED (64 to short BFP) (CEGBR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_Reg_28_31}},
	{CEGBRA, 0xffff000000000000, 0xb3a4000000000000, // CONVERT FROM FIXED (64 to short BFP) (CEGBRA R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_Reg_28_31, ap_Mask_20_23}},
	{CEGR, 0xffff000000000000, 0xb3c4000000000000, // CONVERT FROM FIXED (64 to short HFP) (CEGR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_Reg_28_31}},
	{CXLFBR, 0xffff000000000000, 0xb392000000000000, // CONVERT FROM LOGICAL (32 to extended BFP) (CXLFBR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CXLFTR, 0xffff000000000000, 0xb95b000000000000, // CONVERT FROM LOGICAL (32 to extended DFP) (CXLFTR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CDLFBR, 0xffff000000000000, 0xb391000000000000, // CONVERT FROM LOGICAL (32 to long BFP) (CDLFBR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CDLFTR, 0xffff000000000000, 0xb953000000000000, // CONVERT FROM LOGICAL (32 to long DFP) (CDLFTR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CELFBR, 0xffff000000000000, 0xb390000000000000, // CONVERT FROM LOGICAL (32 to short BFP) (CELFBR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CXLGBR, 0xffff000000000000, 0xb3a2000000000000, // CONVERT FROM LOGICAL (64 to extended BFP) (CXLGBR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CXLGTR, 0xffff000000000000, 0xb95a000000000000, // CONVERT FROM LOGICAL (64 to extended DFP) (CXLGTR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CDLGBR, 0xffff000000000000, 0xb3a1000000000000, // CONVERT FROM LOGICAL (64 to long BFP) (CDLGBR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CDLGTR, 0xffff000000000000, 0xb952000000000000, // CONVERT FROM LOGICAL (64 to long DFP) (CDLGTR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CELGBR, 0xffff000000000000, 0xb3a0000000000000, // CONVERT FROM LOGICAL (64 to short BFP) (CELGBR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	...
	{CFXBRA, 0xffff000000000000, 0xb39a000000000000, // CONVERT TO FIXED (extended BFP to 32) (CFXBRA R1,M3,R2,M4)
	...
	{CGXBR, 0xffff000000000000, 0xb3aa000000000000, // CONVERT TO FIXED (extended BFP to 64) (CGXBR R1,M3,R2)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31}},
	{CGXBRA, 0xffff000000000000, 0xb3aa000000000000, // CONVERT TO FIXED (extended BFP to 64) (CGXBRA R1,M3,R2,M4)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CFXTR, 0xffff000000000000, 0xb949000000000000, // CONVERT TO FIXED (extended DFP to 32) (CFXTR R1,M3,R2,M4)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CGXTR, 0xffff000000000000, 0xb3e9000000000000, // CONVERT TO FIXED (extended DFP to 64) (CGXTR R1,M3,R2)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31}},
	{CGXTRA, 0xffff000000000000, 0xb3e9000000000000, // CONVERT TO FIXED (extended DFP to 64) (CGXTRA R1,M3,R2,M4)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	...
	{CFDBR, 0xffff000000000000, 0xb399000000000000, // CONVERT TO FIXED (long BFP to 32) (CFDBR R1,M3,R2)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31}},
	{CFDBRA, 0xffff000000000000, 0xb399000000000000, // CONVERT TO FIXED (long BFP to 32) (CFDBRA R1,M3,R2,M4)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CGDBR, 0xffff000000000000, 0xb3a9000000000000, // CONVERT TO FIXED (long BFP to 64) (CGDBR R1,M3,R2)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31}},
	{CGDBRA, 0xffff000000000000, 0xb3a9000000000000, // CONVERT TO FIXED (long BFP to 64) (CGDBRA R1,M3,R2,M4)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CFDTR, 0xffff000000000000, 0xb941000000000000, // CONVERT TO FIXED (long DFP to 32) (CFDTR R1,M3,R2,M4)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CGDTR, 0xffff000000000000, 0xb3e1000000000000, // CONVERT TO FIXED (long DFP to 64) (CGDTR R1,M3,R2)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31}},
	{CGDTRA, 0xffff000000000000, 0xb3e1000000000000, // CONVERT TO FIXED (long DFP to 64) (CGDTRA R1,M3,R2,M4)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	...
	{CFEBR, 0xffff000000000000, 0xb398000000000000, // CONVERT TO FIXED (short BFP to 32) (CFEBR R1,M3,R2)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31}},
	{CFEBRA, 0xffff000000000000, 0xb398000000000000, // CONVERT TO FIXED (short BFP to 32) (CFEBRA R1,M3,R2,M4)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CGEBR, 0xffff000000000000, 0xb3a8000000000000, // CONVERT TO FIXED (short BFP to 64) (CGEBR R1,M3,R2)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31}},
	{CGEBRA, 0xffff000000000000, 0xb3a8000000000000, // CONVERT TO FIXED (short BFP to 64) (CGEBRA R1,M3,R2,M4)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	...
	{CGER, 0xffff000000000000, 0xb3c8000000000000, // CONVERT TO FIXED (short HFP to 64) (CGER R1,M3,R2)
		[8]*argField{ap_Reg_24_27, ap_Mask_16_19, ap_FPReg_28_31}},
	{CLFXBR, 0xffff000000000000, 0xb39e000000000000, // CONVERT TO LOGICAL (extended BFP to 32) (CLFXBR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CLGXBR, 0xffff000000000000, 0xb3ae000000000000, // CONVERT TO LOGICAL (extended BFP to 64) (CLGXBR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CLFXTR, 0xffff000000000000, 0xb94b000000000000, // CONVERT TO LOGICAL (extended DFP to 32) (CLFXTR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CLGXTR, 0xffff000000000000, 0xb94a000000000000, // CONVERT TO LOGICAL (extended DFP to 64) (CLGXTR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CLFDBR, 0xffff000000000000, 0xb39d000000000000, // CONVERT TO LOGICAL (long BFP to 32) (CLFDBR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CLGDBR, 0xffff000000000000, 0xb3ad000000000000, // CONVERT TO LOGICAL (long BFP to 64) (CLGDBR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CLFDTR, 0xffff000000000000, 0xb943000000000000, // CONVERT TO LOGICAL (long DFP to 32) (CLFDTR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CLGDTR, 0xffff000000000000, 0xb942000000000000, // CONVERT TO LOGICAL (long DFP to 64) (CLGDTR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CLFEBR, 0xffff000000000000, 0xb39c000000000000, // CONVERT TO LOGICAL (short BFP to 32) (CLFEBR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{CLGEBR, 0xffff000000000000, 0xb3ac000000000000, // CONVERT TO LOGICAL (short BFP to 64) (CLGEBR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	...
	{VSCSHP, 0xff00000000ff0000, 0xe6000000007c0000, // DECIMAL SCALE AND CONVERT AND SPLIT TO HFP (VSCSHP V1,V2,V3)
	...
	{DXTR, 0xffff000000000000, 0xb3d9000000000000, // DIVIDE (extended DFP) (DXTR R1,R2,R3)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_FPReg_16_19}},
	{DXTRA, 0xffff000000000000, 0xb3d9000000000000, // DIVIDE (extended DFP) (DXTRA R1,R2,R3,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_FPReg_16_19, ap_Mask_20_23}},
	{DXR, 0xffff000000000000, 0xb22d000000000000, // DIVIDE (extended HFP) (DXR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{DDB, 0xff00000000ff0000, 0xed000000001d0000, // DIVIDE (long BFP) (DDB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{DDTR, 0xffff000000000000, 0xb3d1000000000000, // DIVIDE (long DFP) (DDTR R1,R2,R3)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_FPReg_16_19}},
	{DDTRA, 0xffff000000000000, 0xb3d1000000000000, // DIVIDE (long DFP) (DDTRA R1,R2,R3,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_FPReg_16_19, ap_Mask_20_23}},
	...
	{DDR, 0xff00000000000000, 0x2d00000000000000, // DIVIDE (long HFP) (DDR R1,R2)
		[8]*argField{ap_FPReg_8_11, ap_FPReg_12_15}},
	{DEB, 0xff00000000ff0000, 0xed000000000d0000, // DIVIDE (short BFP) (DEB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{DSGFR, 0xffff000000000000, 0xb91d000000000000, // DIVIDE SINGLE (64→32) (DSGFR R1,R2)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31}},
	{DIDBR, 0xffff000000000000, 0xb35b000000000000, // DIVIDE TO INTEGER (long BFP) (DIDBR R1,R3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{DIEBR, 0xffff000000000000, 0xb353000000000000, // DIVIDE TO INTEGER (short BFP) (DIEBR R1,R3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{ED, 0xff00000000000000, 0xde00000000000000, // EDIT (ED D1(L1,B1),D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_15, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	{EDMK, 0xff00000000000000, 0xdf00000000000000, // EDIT AND MARK (EDMK D1(L1,B1),D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_15, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	...
	{XGRK, 0xffff000000000000, 0xb9e7000000000000, // EXCLUSIVE OR (64) (XGRK R1,R2,R3)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31, ap_Reg_16_19}},
	{XC, 0xff00000000000000, 0xd700000000000000, // EXCLUSIVE OR (character) (XC D1(L1,B1),D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_15, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	...
	{EX, 0xff00000000000000, 0x4400000000000000, // EXECUTE (EX R1,D2(X2,B2))
		[8]*argField{ap_Reg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{EXRL, 0xff0f000000000000, 0xc600000000000000, // EXECUTE RELATIVE LONG (EXRL R1,RI2)
		[8]*argField{ap_Reg_8_11, ap_RegImSigned32_16_47}},
	{EAR, 0xffff000000000000, 0xb24f000000000000, // EXTRACT ACCESS (EAR R1,R2)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31}},
	{ESEA, 0xffff000000000000, 0xb99d000000000000, // EXTRACT AND SET EXTENDED AUTHORITY (ESEA R1)
	...
	{EFPC, 0xffff000000000000, 0xb38c000000000000, // EXTRACT FPC (EFPC R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{EPAR, 0xffff000000000000, 0xb226000000000000, // EXTRACT PRIMARY ASN (EPAR R1)
		[8]*argField{ap_Reg_24_27}},
	{EPAIR, 0xffff000000000000, 0xb99a000000000000, // EXTRACT PRIMARY ASN AND INSTANCE (EPAIR R1)
		[8]*argField{ap_Reg_24_27}},
	{EPSW, 0xffff000000000000, 0xb98d000000000000, // EXTRACT PSW (EPSW R1,R2)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31}},
	{ESAR, 0xffff000000000000, 0xb227000000000000, // EXTRACT SECONDARY ASN (ESAR R1)
		[8]*argField{ap_Reg_24_27}},
	{ESAIR, 0xffff000000000000, 0xb99b000000000000, // EXTRACT SECONDARY ASN AND INSTANCE (ESAIR R1)
		[8]*argField{ap_Reg_24_27}},
	...
	{ESTA, 0xffff000000000000, 0xb24a000000000000, // EXTRACT STACKED STATE (ESTA R1,R2)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31}},
	{ETND, 0xffff000000000000, 0xb2ec000000000000, // EXTRACT TRANSACTION NESTING DEPTH (ETND R1)
		[8]*argField{ap_Reg_24_27}},
	...
	{HER, 0xff00000000000000, 0x3400000000000000, // HALVE (short HFP) (HER R1,R2)
		[8]*argField{ap_FPReg_8_11, ap_FPReg_12_15}},
	{IAC, 0xffff000000000000, 0xb224000000000000, // INSERT ADDRESS SPACE CONTROL (IAC R1)
		[8]*argField{ap_Reg_24_27}},
	...
	{ICMY, 0xff00000000ff0000, 0xeb00000000810000, // INSERT CHARACTERS UNDER MASK (low) (ICMY R1,M3,D2(B2))
		[8]*argField{ap_Reg_8_11, ap_Mask_12_15, ap_DispSigned20_20_39, ap_BaseReg_16_19}},
	{IIHH, 0xff0f000000000000, 0xa500000000000000, // INSERT IMMEDIATE (high high) (IIHH R1,I2)
		[8]*argField{ap_Reg_8_11, ap_ImmUnsigned_16_31}},
	...
	{IILF, 0xff0f000000000000, 0xc009000000000000, // INSERT IMMEDIATE (low) (IILF R1,I2)
		[8]*argField{ap_Reg_8_11, ap_ImmUnsigned_16_47}},
	{IPM, 0xffff000000000000, 0xb222000000000000, // INSERT PROGRAM MASK (IPM R1)
		[8]*argField{ap_Reg_24_27}},
	...
	{IVSK, 0xffff000000000000, 0xb223000000000000, // INSERT VIRTUAL STORAGE KEY (IVSK R1,R2)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31}},
	{IDTE, 0xffff000000000000, 0xb98e000000000000, // INVALIDATE DAT TABLE ENTRY (IDTE R1,R3,R2,M4)
		[8]*argField{ap_Reg_24_27, ap_Reg_16_19, ap_Reg_28_31, ap_Mask_20_23}},
	{IPTE, 0xffff000000000000, 0xb221000000000000, // INVALIDATE PAGE TABLE ENTRY (IPTE R1,R2,R3,M4)
	...
	{LAEY, 0xff00000000ff0000, 0xe300000000750000, // LOAD ADDRESS EXTENDED (LAEY R1,D2(X2,B2))
		[8]*argField{ap_Reg_8_11, ap_DispSigned20_20_39, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{LARL, 0xff0f000000000000, 0xc000000000000000, // LOAD ADDRESS RELATIVE LONG (LARL R1,RI2)
		[8]*argField{ap_Reg_8_11, ap_RegImSigned32_16_47}},
	...
	{FIXBR, 0xffff000000000000, 0xb347000000000000, // LOAD FP INTEGER (extended BFP) (FIXBR R1,M3,R2)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31}},
	{FIXBRA, 0xffff000000000000, 0xb347000000000000, // LOAD FP INTEGER (extended BFP) (FIXBRA R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{FIXTR, 0xffff000000000000, 0xb3df000000000000, // LOAD FP INTEGER (extended DFP) (FIXTR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	...
	{FIDBR, 0xffff000000000000, 0xb35f000000000000, // LOAD FP INTEGER (long BFP) (FIDBR R1,M3,R2)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31}},
	{FIDBRA, 0xffff000000000000, 0xb35f000000000000, // LOAD FP INTEGER (long BFP) (FIDBRA R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{FIDTR, 0xffff000000000000, 0xb3d7000000000000, // LOAD FP INTEGER (long DFP) (FIDTR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	...
	{FIEBR, 0xffff000000000000, 0xb357000000000000, // LOAD FP INTEGER (short BFP) (FIEBR R1,M3,R2)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31}},
	{FIEBRA, 0xffff000000000000, 0xb357000000000000, // LOAD FP INTEGER (short BFP) (FIEBRA R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	...
	{LFHAT, 0xff00000000ff0000, 0xe300000000c80000, // LOAD HIGH AND TRAP (32H←32) (LFHAT R1,D2(X2,B2))
		[8]*argField{ap_Reg_8_11, ap_DispSigned20_20_39, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{LOCFH, 0xff00000000ff0000, 0xeb00000000e00000, // LOAD HIGH ON CONDITION (32) (LOCFH R1,D2(B2),M3)
	...
	{LGFI, 0xff0f000000000000, 0xc001000000000000, // LOAD IMMEDIATE (64→32) (LGFI R1,I2)
		[8]*argField{ap_Reg_8_11, ap_ImmUnsigned_16_47}},
	{LXDB, 0xff00000000ff0000, 0xed00000000050000, // LOAD LENGTHENED (long to extended BFP) (LXDB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{LXDTR, 0xffff000000000000, 0xb3dc000000000000, // LOAD LENGTHENED (long to extended DFP) (LXDTR R1,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_Mask_20_23}},
	{LXD, 0xff00000000ff0000, 0xed00000000250000, // LOAD LENGTHENED (long to extended HFP) (LXD R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{LXDR, 0xffff000000000000, 0xb325000000000000, // LOAD LENGTHENED (long to extended HFP) (LXDR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{LXEB, 0xff00000000ff0000, 0xed00000000060000, // LOAD LENGTHENED (short to extended BFP) (LXEB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{LXEBR, 0xffff000000000000, 0xb306000000000000, // LOAD LENGTHENED (short to extended BFP) (LXEBR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{LXE, 0xff00000000ff0000, 0xed00000000260000, // LOAD LENGTHENED (short to extended HFP) (LXE R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{LXER, 0xffff000000000000, 0xb326000000000000, // LOAD LENGTHENED (short to extended HFP) (LXER R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{LDEB, 0xff00000000ff0000, 0xed00000000040000, // LOAD LENGTHENED (short to long BFP) (LDEB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{LDETR, 0xffff000000000000, 0xb3d4000000000000, // LOAD LENGTHENED (short to long DFP) (LDETR R1,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_Mask_20_23}},
	{LDE, 0xff00000000ff0000, 0xed00000000240000, // LOAD LENGTHENED (short to long HFP) (LDE R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{LMG, 0xff00000000ff0000, 0xeb00000000040000, // LOAD MULTIPLE (64) (LMG R1,R3,D2(B2))
		[8]*argField{ap_Reg_8_11, ap_Reg_12_15, ap_DispSigned20_20_39, ap_BaseReg_16_19}},
	{LMD, 0xff00000000000000, 0xef00000000000000, // LOAD MULTIPLE DISJOINT (64→32&32) (LMD R1,R3,D2(B2),D4(B4))
	...
	{LNER, 0xff00000000000000, 0x3100000000000000, // LOAD NEGATIVE (short HFP) (LNER R1,R2)
		[8]*argField{ap_FPReg_8_11, ap_FPReg_12_15}},
	{LOC, 0xff00000000ff0000, 0xeb00000000f20000, // LOAD ON CONDITION (32) (LOC R1,D2(B2),M3)
		[8]*argField{ap_Reg_8_11, ap_DispSigned20_20_39, ap_BaseReg_16_19, ap_Mask_12_15}},
	{LOCR, 0xffff000000000000, 0xb9f2000000000000, // LOAD ON CONDITION (32) (LOCR R1,R2,M3)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31, ap_Mask_16_19}},
	{LOCG, 0xff00000000ff0000, 0xeb00000000e20000, // LOAD ON CONDITION (64) (LOCG R1,D2(B2),M3)
		[8]*argField{ap_Reg_8_11, ap_DispSigned20_20_39, ap_BaseReg_16_19, ap_Mask_12_15}},
	{LOCGR, 0xffff000000000000, 0xb9e2000000000000, // LOAD ON CONDITION (64) (LOCGR R1,R2,M3)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31, ap_Mask_16_19}},
	{LPTEA, 0xffff000000000000, 0xb9aa000000000000, // LOAD PAGE TABLE ENTRY ADDRESS (LPTEA R1,R3,R2,M4)
		[8]*argField{ap_Reg_24_27, ap_Reg_16_19, ap_Reg_28_31, ap_Mask_20_23}},
	{LPD, 0xff0f000000000000, 0xc804000000000000, // LOAD PAIR DISJOINT (32) (LPD R3,D1(B1),D2(B2))
		[8]*argField{ap_Reg_8_11, ap_DispUnsigned_20_31, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	{LPDG, 0xff0f000000000000, 0xc805000000000000, // LOAD PAIR DISJOINT (64) (LPDG R3,D1(B1),D2(B2))
		[8]*argField{ap_Reg_8_11, ap_DispUnsigned_20_31, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	...
	{LPER, 0xff00000000000000, 0x3000000000000000, // LOAD POSITIVE (short HFP) (LPER R1,R2)
		[8]*argField{ap_FPReg_8_11, ap_FPReg_12_15}},
	{LPSW, 0xff00000000000000, 0x8200000000000000, // LOAD PSW (LPSW D1(B1))
		[8]*argField{ap_DispUnsigned_20_31, ap_BaseReg_16_19}},
	{LPSWE, 0xffff000000000000, 0xb2b2000000000000, // LOAD PSW EXTENDED (LPSWE D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_BaseReg_16_19}},
	{LPSWEY, 0xff00000000ff0000, 0xeb00000000710000, // LOAD PSW EXTENDED (LPSWEY D1(B1))
	...
	{LDXBR, 0xffff000000000000, 0xb345000000000000, // LOAD ROUNDED (extended to long BFP) (LDXBR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{LDXBRA, 0xffff000000000000, 0xb345000000000000, // LOAD ROUNDED (extended to long BFP) (LDXBRA R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{LDXTR, 0xffff000000000000, 0xb3dd000000000000, // LOAD ROUNDED (extended to long DFP) (LDXTR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	...
	{LEXBR, 0xffff000000000000, 0xb346000000000000, // LOAD ROUNDED (extended to short BFP) (LEXBR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{LEXBRA, 0xffff000000000000, 0xb346000000000000, // LOAD ROUNDED (extended to short BFP) (LEXBRA R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	...
	{LEDBR, 0xffff000000000000, 0xb344000000000000, // LOAD ROUNDED (long to short BFP) (LEDBR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{LEDBRA, 0xffff000000000000, 0xb344000000000000, // LOAD ROUNDED (long to short BFP) (LEDBRA R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{LEDTR, 0xffff000000000000, 0xb3d5000000000000, // LOAD ROUNDED (long to short DFP) (LEDTR R1,M3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_Mask_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	...
	{LURAG, 0xffff000000000000, 0xb905000000000000, // LOAD USING REAL ADDRESS (64) (LURAG R1,R2)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31}},
	{LZXR, 0xffff000000000000, 0xb376000000000000, // LOAD ZERO (extended) (LZXR R1)
		[8]*argField{ap_FPReg_24_27}},
	{LZDR, 0xffff000000000000, 0xb375000000000000, // LOAD ZERO (long) (LZDR R1)
		[8]*argField{ap_FPReg_24_27}},
	{LZER, 0xffff000000000000, 0xb374000000000000, // LOAD ZERO (short) (LZER R1)
		[8]*argField{ap_FPReg_24_27}},
	{MSTA, 0xffff000000000000, 0xb247000000000000, // MODIFY STACKED STATE (MSTA R1)
		[8]*argField{ap_Reg_24_27}},
	...
	{MVGHI, 0xffff000000000000, 0xe548000000000000, // MOVE (64←16) (MVGHI D1(B1),I2)
		[8]*argField{ap_DispUnsigned_20_31, ap_BaseReg_16_19, ap_ImmSigned16_32_47}},
	{MVC, 0xff00000000000000, 0xd200000000000000, // MOVE (character) (MVC D1(L1,B1),D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_15, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	...
	{MVIY, 0xff00000000ff0000, 0xeb00000000520000, // MOVE (immediate) (MVIY D1(B1),I2)
		[8]*argField{ap_DispSigned20_20_39, ap_BaseReg_16_19, ap_ImmUnsigned_8_15}},
	{MVCIN, 0xff00000000000000, 0xe800000000000000, // MOVE INVERSE (MVCIN D1(L1,B1),D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_15, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	...
	{MVCLU, 0xff00000000ff0000, 0xeb000000008e0000, // MOVE LONG UNICODE (MVCLU R1,R3,D2(B2))
		[8]*argField{ap_Reg_8_11, ap_Reg_12_15, ap_DispSigned20_20_39, ap_BaseReg_16_19}},
	{MVN, 0xff00000000000000, 0xd100000000000000, // MOVE NUMERICS (MVN D1(L1,B1),D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_15, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	...
	{MVO, 0xff00000000000000, 0xf100000000000000, // MOVE WITH OFFSET (MVO D1(L1,B1),D2(L2,B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_11, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_Len_12_15, ap_BaseReg_32_35}},
	{MVCOS, 0xff0f000000000000, 0xc800000000000000, // MOVE WITH OPTIONAL SPECIFICATIONS (MVCOS D1(B1),D2(B2),R3)
		[8]*argField{ap_DispUnsigned_20_31, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35, ap_Reg_8_11}},
	{MVCSK, 0xffff000000000000, 0xe50e000000000000, // MOVE WITH SOURCE KEY (MVCSK D1(B1),D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	{MVZ, 0xff00000000000000, 0xd300000000000000, // MOVE ZONES (MVZ D1(L1,B1),D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_15, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	...
	{MXTR, 0xffff000000000000, 0xb3d8000000000000, // MULTIPLY (extended DFP) (MXTR R1,R2,R3)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_FPReg_16_19}},
	{MXTRA, 0xffff000000000000, 0xb3d8000000000000, // MULTIPLY (extended DFP) (MXTRA R1,R2,R3,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_FPReg_16_19, ap_Mask_20_23}},
	{MXR, 0xff00000000000000, 0x2600000000000000, // MULTIPLY (extended HFP) (MXR R1,R2)
		[8]*argField{ap_FPReg_8_11, ap_FPReg_12_15}},
	{MDB, 0xff00000000ff0000, 0xed000000001c0000, // MULTIPLY (long BFP) (MDB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{MDTR, 0xffff000000000000, 0xb3d0000000000000, // MULTIPLY (long DFP) (MDTR R1,R2,R3)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_FPReg_16_19}},
	{MDTRA, 0xffff000000000000, 0xb3d0000000000000, // MULTIPLY (long DFP) (MDTRA R1,R2,R3,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_FPReg_16_19, ap_Mask_20_23}},
	...
	{MDR, 0xff00000000000000, 0x2c00000000000000, // MULTIPLY (long HFP) (MDR R1,R2)
		[8]*argField{ap_FPReg_8_11, ap_FPReg_12_15}},
	{MXDB, 0xff00000000ff0000, 0xed00000000070000, // MULTIPLY (long to extended BFP) (MXDB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{MXDR, 0xff00000000000000, 0x2700000000000000, // MULTIPLY (long to extended HFP) (MXDR R1,R2)
		[8]*argField{ap_FPReg_8_11, ap_FPReg_12_15}},
	{MEEB, 0xff00000000ff0000, 0xed00000000170000, // MULTIPLY (short BFP) (MEEB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{MEEBR, 0xffff000000000000, 0xb317000000000000, // MULTIPLY (short BFP) (MEEBR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{MEE, 0xff00000000ff0000, 0xed00000000370000, // MULTIPLY (short HFP) (MEE R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{MEER, 0xffff000000000000, 0xb337000000000000, // MULTIPLY (short HFP) (MEER R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{MDEB, 0xff00000000ff0000, 0xed000000000c0000, // MULTIPLY (short to long BFP) (MDEB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{MSFI, 0xff0f000000000000, 0xc201000000000000, // MULTIPLY SINGLE IMMEDIATE (32) (MSFI R1,I2)
		[8]*argField{ap_Reg_8_11, ap_ImmUnsigned_16_47}},
	{MSGFI, 0xff0f000000000000, 0xc200000000000000, // MULTIPLY SINGLE IMMEDIATE (64←32) (MSGFI R1,I2)
		[8]*argField{ap_Reg_8_11, ap_ImmUnsigned_16_47}},
	...
	{NNGRK, 0xffff000000000000, 0xb964000000000000, // NAND (64) (NNGRK R1,R2,R3)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31, ap_Reg_16_19}},
	{NNPA, 0xffff000000000000, 0xb93b000000000000, // NEURAL NETWORK PROCESSING ASSIST (NNPA)
		[8]*argField{}},
	...
	{OGRK, 0xffff000000000000, 0xb9e6000000000000, // OR (64) (OGRK R1,R2,R3)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31, ap_Reg_16_19}},
	{OC, 0xff00000000000000, 0xd600000000000000, // OR (character) (OC D1(L1,B1),D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_15, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	...
	{PGOUT, 0xffff000000000000, 0xb22f000000000000, // PAGE OUT (PGOUT R1,R2)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31}},
	{PCC, 0xffff000000000000, 0xb92c000000000000, // PERFORM CRYPTOGRAPHIC COMPUTATION (PCC)
		[8]*argField{}},
	{PCKMO, 0xffff000000000000, 0xb928000000000000, // PERFORM CRYPTOGRAPHIC KEY MGMT. OPERATIONS (PCKMO)
		[8]*argField{}},
	...
	{PTFF, 0xffff000000000000, 0x104000000000000, // PERFORM TIMING FACILITY FUNCTION (PTFF)
		[8]*argField{}},
	{PTF, 0xffff000000000000, 0xb9a2000000000000, // PERFORM TOPOLOGY FUNCTION (PTF R1)
		[8]*argField{ap_Reg_24_27}},
	...
	{PTI, 0xffff000000000000, 0xb99e000000000000, // PROGRAM TRANSFER WITH INSTANCE (PTI R1,R2)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31}},
	{PALB, 0xffff000000000000, 0xb248000000000000, // PURGE ALB (PALB)
		[8]*argField{}},
	{PTLB, 0xffff000000000000, 0xb20d000000000000, // PURGE TLB (PTLB)
		[8]*argField{}},
	{QAXTR, 0xffff000000000000, 0xb3fd000000000000, // QUANTIZE (extended DFP) (QAXTR R1,R3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{QADTR, 0xffff000000000000, 0xb3f5000000000000, // QUANTIZE (long DFP) (QADTR R1,R3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{QPACI, 0xffff000000000000, 0xb28f000000000000, // QUERY PROCESSOR ACTIVITY COUNTER INFORMATION (QPACI D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_BaseReg_16_19}},
	{RRXTR, 0xffff000000000000, 0xb3ff000000000000, // REROUND (extended DFP) (RRXTR R1,R3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{RRDTR, 0xffff000000000000, 0xb3f7000000000000, // REROUND (long DFP) (RRDTR R1,R3,R2,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_16_19, ap_FPReg_28_31, ap_Mask_20_23}},
	{RCHP, 0xffff000000000000, 0xb23b000000000000, // RESET CHANNEL PATH (RCHP)
		[8]*argField{}},
	{RDP, 0xffff000000000000, 0xb98b000000000000, // RESET DAT PROTECTION (RDP R1,R3,R2,M4)
		[8]*argField{ap_Reg_24_27, ap_Reg_16_19, ap_Reg_28_31, ap_Mask_20_23}},
	...
	{SRSTU, 0xffff000000000000, 0xb9be000000000000, // SEARCH STRING UNICODE (SRSTU R1,R2)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31}},
	{SELR, 0xffff000000000000, 0xb9f0000000000000, // SELECT (32) (SELR R1,R2,R3,M4)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31, ap_Reg_16_19, ap_Mask_20_23}},
	{SELGR, 0xffff000000000000, 0xb9e3000000000000, // SELECT (64) (SELGR R1,R2,R3,M4)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31, ap_Reg_16_19, ap_Mask_20_23}},
	{SELFHR, 0xffff000000000000, 0xb9c0000000000000, // SELECT HIGH (32) (SELFHR R1,R2,R3,M4)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31, ap_Reg_16_19, ap_Mask_20_23}},
	...
	{SFPC, 0xffff000000000000, 0xb384000000000000, // SET FPC (SFPC R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{SFASR, 0xffff000000000000, 0xb385000000000000, // SET FPC AND SIGNAL (SFASR R1)
		[8]*argField{ap_FPReg_24_27}},
	{SPX, 0xffff000000000000, 0xb210000000000000, // SET PREFIX (SPX D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_BaseReg_16_19}},
	{SPM, 0xff00000000000000, 0x400000000000000, // SET PROGRAM MASK (SPM R1)
		[8]*argField{ap_Reg_8_11}},
	{SPKA, 0xffff000000000000, 0xb20a000000000000, // SET PSW KEY FROM ADDRESS (SPKA D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_BaseReg_16_19}},
	{SSAR, 0xffff000000000000, 0xb225000000000000, // SET SECONDARY ASN (SSAR R1)
		[8]*argField{ap_Reg_24_27}},
	{SSAIR, 0xffff000000000000, 0xb99f000000000000, // SET SECONDARY ASN WITH INSTANCE (SSAIR R1)
		[8]*argField{ap_Reg_24_27}},
	{SSKE, 0xffff000000000000, 0xb22b000000000000, // SET STORAGE KEY EXTENDED (SSKE R1,R2,M3)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31, ap_Mask_16_19}},
	{SSM, 0xff00000000000000, 0x8000000000000000, // SET SYSTEM MASK (SSM D1(B1))
		[8]*argField{ap_DispUnsigned_20_31, ap_BaseReg_16_19}},
	...
	{SLDA, 0xff00000000000000, 0x8f00000000000000, // SHIFT LEFT DOUBLE (64) (SLDA R1,D2(B2))
		[8]*argField{ap_Reg_8_11, ap_DispUnsigned_20_31, ap_BaseReg_16_19}},
	{SLDL, 0xff00000000000000, 0x8d00000000000000, // SHIFT LEFT DOUBLE LOGICAL (64) (SLDL R1,D2(B2))
		[8]*argField{ap_Reg_8_11, ap_DispUnsigned_20_31, ap_BaseReg_16_19}},
	{SLA, 0xff00000000000000, 0x8b00000000000000, // SHIFT LEFT SINGLE (32) (SLA R1,D2(B2))
		[8]*argField{ap_Reg_8_11, ap_DispUnsigned_20_31, ap_BaseReg_16_19}},
	...
	{SLAG, 0xff00000000ff0000, 0xeb000000000b0000, // SHIFT LEFT SINGLE (64) (SLAG R1,R3,D2(B2))
		[8]*argField{ap_Reg_8_11, ap_Reg_12_15, ap_DispSigned20_20_39, ap_BaseReg_16_19}},
	{SLL, 0xff00000000000000, 0x8900000000000000, // SHIFT LEFT SINGLE LOGICAL (32) (SLL R1,D2(B2))
		[8]*argField{ap_Reg_8_11, ap_DispUnsigned_20_31, ap_BaseReg_16_19}},
	...
	{SLLG, 0xff00000000ff0000, 0xeb000000000d0000, // SHIFT LEFT SINGLE LOGICAL (64) (SLLG R1,R3,D2(B2))
		[8]*argField{ap_Reg_8_11, ap_Reg_12_15, ap_DispSigned20_20_39, ap_BaseReg_16_19}},
	{SRDA, 0xff00000000000000, 0x8e00000000000000, // SHIFT RIGHT DOUBLE (64) (SRDA R1,D2(B2))
		[8]*argField{ap_Reg_8_11, ap_DispUnsigned_20_31, ap_BaseReg_16_19}},
	{SRDL, 0xff00000000000000, 0x8c00000000000000, // SHIFT RIGHT DOUBLE LOGICAL (64) (SRDL R1,D2(B2))
		[8]*argField{ap_Reg_8_11, ap_DispUnsigned_20_31, ap_BaseReg_16_19}},
	{SRA, 0xff00000000000000, 0x8a00000000000000, // SHIFT RIGHT SINGLE (32) (SRA R1,D2(B2))
		[8]*argField{ap_Reg_8_11, ap_DispUnsigned_20_31, ap_BaseReg_16_19}},
	...
	{SRAG, 0xff00000000ff0000, 0xeb000000000a0000, // SHIFT RIGHT SINGLE (64) (SRAG R1,R3,D2(B2))
		[8]*argField{ap_Reg_8_11, ap_Reg_12_15, ap_DispSigned20_20_39, ap_BaseReg_16_19}},
	{SRL, 0xff00000000000000, 0x8800000000000000, // SHIFT RIGHT SINGLE LOGICAL (32) (SRL R1,D2(B2))
		[8]*argField{ap_Reg_8_11, ap_DispUnsigned_20_31, ap_BaseReg_16_19}},
	...
	{SQXR, 0xffff000000000000, 0xb336000000000000, // SQUARE ROOT (extended HFP) (SQXR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{SQDB, 0xff00000000ff0000, 0xed00000000150000, // SQUARE ROOT (long BFP) (SQDB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{SQDBR, 0xffff000000000000, 0xb315000000000000, // SQUARE ROOT (long BFP) (SQDBR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{SQD, 0xff00000000ff0000, 0xed00000000350000, // SQUARE ROOT (long HFP) (SQD R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{SQDR, 0xffff000000000000, 0xb244000000000000, // SQUARE ROOT (long HFP) (SQDR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{SQEB, 0xff00000000ff0000, 0xed00000000140000, // SQUARE ROOT (short BFP) (SQEB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{SQEBR, 0xffff000000000000, 0xb314000000000000, // SQUARE ROOT (short BFP) (SQEBR R1,R2)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31}},
	{SQE, 0xff00000000ff0000, 0xed00000000340000, // SQUARE ROOT (short HFP) (SQE R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{STFH, 0xff00000000ff0000, 0xe300000000cb0000, // STORE HIGH (32) (STFH R1,D2(X2,B2))
		[8]*argField{ap_Reg_8_11, ap_DispSigned20_20_39, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{STOCFH, 0xff00000000ff0000, 0xeb00000000e10000, // STORE HIGH ON CONDITION (STOCFH R1,D2(B2),M3)
		[8]*argField{ap_Reg_8_11, ap_DispSigned20_20_39, ap_BaseReg_16_19, ap_Mask_12_15}},
	...
	{STMH, 0xff00000000ff0000, 0xeb00000000260000, // STORE MULTIPLE HIGH (32) (STMH R1,R3,D2(B2))
		[8]*argField{ap_Reg_8_11, ap_Reg_12_15, ap_DispSigned20_20_39, ap_BaseReg_16_19}},
	{STOC, 0xff00000000ff0000, 0xeb00000000f30000, // STORE ON CONDITION (32) (STOC R1,D2(B2),M3)
		[8]*argField{ap_Reg_8_11, ap_DispSigned20_20_39, ap_BaseReg_16_19, ap_Mask_12_15}},
	{STOCG, 0xff00000000ff0000, 0xeb00000000e30000, // STORE ON CONDITION (64) (STOCG R1,D2(B2),M3)
		[8]*argField{ap_Reg_8_11, ap_DispSigned20_20_39, ap_BaseReg_16_19, ap_Mask_12_15}},
	...
	{SXTR, 0xffff000000000000, 0xb3db000000000000, // SUBTRACT (extended DFP) (SXTR R1,R2,R3)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_FPReg_16_19}},
	{SXTRA, 0xffff000000000000, 0xb3db000000000000, // SUBTRACT (extended DFP) (SXTRA R1,R2,R3,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_FPReg_16_19, ap_Mask_20_23}},
	{SDB, 0xff00000000ff0000, 0xed000000001b0000, // SUBTRACT (long BFP) (SDB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{SDTR, 0xffff000000000000, 0xb3d3000000000000, // SUBTRACT (long DFP) (SDTR R1,R2,R3)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_FPReg_16_19}},
	{SDTRA, 0xffff000000000000, 0xb3d3000000000000, // SUBTRACT (long DFP) (SDTRA R1,R2,R3,M4)
		[8]*argField{ap_FPReg_24_27, ap_FPReg_28_31, ap_FPReg_16_19, ap_Mask_20_23}},
	{SEB, 0xff00000000ff0000, 0xed000000000b0000, // SUBTRACT (short BFP) (SEB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{TAM, 0xffff000000000000, 0x10b000000000000, // TEST ADDRESSING MODE (TAM)
		[8]*argField{}},
	{TS, 0xff00000000000000, 0x9300000000000000, // TEST AND SET (TS D1(B1))
		[8]*argField{ap_DispUnsigned_20_31, ap_BaseReg_16_19}},
	{TB, 0xffff000000000000, 0xb22c000000000000, // TEST BLOCK (TB R1,R2)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31}},
	{TCXB, 0xff00000000ff0000, 0xed00000000120000, // TEST DATA CLASS (extended BFP) (TCXB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{TDCXT, 0xff00000000ff0000, 0xed00000000580000, // TEST DATA CLASS (extended DFP) (TDCXT R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{TCDB, 0xff00000000ff0000, 0xed00000000110000, // TEST DATA CLASS (long BFP) (TCDB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{TDCDT, 0xff00000000ff0000, 0xed00000000540000, // TEST DATA CLASS (long DFP) (TDCDT R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{TCEB, 0xff00000000ff0000, 0xed00000000100000, // TEST DATA CLASS (short BFP) (TCEB R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{TDCET, 0xff00000000ff0000, 0xed00000000500000, // TEST DATA CLASS (short DFP) (TDCET R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{TDGXT, 0xff00000000ff0000, 0xed00000000590000, // TEST DATA GROUP (extended DFP) (TDGXT R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{TDGDT, 0xff00000000ff0000, 0xed00000000550000, // TEST DATA GROUP (long DFP) (TDGDT R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	{TDGET, 0xff00000000ff0000, 0xed00000000510000, // TEST DATA GROUP (short DFP) (TDGET R1,D2(X2,B2))
		[8]*argField{ap_FPReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19}},
	...
	{TMHL, 0xff0f000000000000, 0xa703000000000000, // TEST UNDER MASK (high low) (TMHL R1,I2)
		[8]*argField{ap_Reg_8_11, ap_ImmUnsigned_16_31}},
	{TMLH, 0xff0f000000000000, 0xa700000000000000, // TEST UNDER MASK (low high) (TMLH R1,I2)
		[8]*argField{ap_Reg_8_11, ap_ImmUnsigned_16_31}},
	{TMLL, 0xff0f000000000000, 0xa701000000000000, // TEST UNDER MASK (low low) (TMLL R1,I2)
		[8]*argField{ap_Reg_8_11, ap_ImmUnsigned_16_31}},
	{TMH, 0xff0f000000000000, 0xa700000000000000, // TEST UNDER MASK HIGH (TMH R1,I2)
		[8]*argField{ap_Reg_8_11, ap_ImmUnsigned_16_31}},
	...
	{TBEGIN, 0xffff000000000000, 0xe560000000000000, // TRANSACTION BEGIN (nonconstrained) (TBEGIN D1(B1),I2)
		[8]*argField{ap_DispUnsigned_20_31, ap_BaseReg_16_19, ap_ImmUnsigned_32_47}},
	{TEND, 0xffff000000000000, 0xb2f8000000000000, // TRANSACTION END (TEND)
		[8]*argField{}},
	{TR, 0xff00000000000000, 0xdc00000000000000, // TRANSLATE (TR D1(L1,B1),D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_15, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	{TRT, 0xff00000000000000, 0xdd00000000000000, // TRANSLATE AND TEST (TRT D1(L1,B1),D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_15, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	{TRTE, 0xffff000000000000, 0xb9bf000000000000, // TRANSLATE AND TEST EXTENDED (TRTE R1,R2,M3)
		[8]*argField{ap_Reg_24_27, ap_Reg_28_31, ap_Mask_16_19}},
	{TRTR, 0xff00000000000000, 0xd000000000000000, // TRANSLATE AND TEST REVERSE (TRTR D1(L1,B1),D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_15, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	...
	{UNPK, 0xff00000000000000, 0xf300000000000000, // UNPACK (UNPK D1(L1,B1),D2(L2,B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_11, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_Len_12_15, ap_BaseReg_32_35}},
	{UNPKA, 0xff00000000000000, 0xea00000000000000, // UNPACK ASCII (UNPKA D1(L1,B1),D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_15, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	{UNPKU, 0xff00000000000000, 0xe200000000000000, // UNPACK UNICODE (UNPKU D1(L1,B1),D2(B2))
		[8]*argField{ap_DispUnsigned_20_31, ap_Len_8_15, ap_BaseReg_16_19, ap_DispUnsigned_36_47, ap_BaseReg_32_35}},
	...
	{VACCC, 0xff00000000ff0000, 0xe700000000b90000, // VECTOR ADD WITH CARRY COMPUTE CARRY (VACCC V1,V2,V3,V4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_VecReg_32_35, ap_Mask_20_23, ap_ImmUnsigned_36_39}},
	{VN, 0xff00000000ff0000, 0xe700000000680000, // VECTOR AND (VN V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	{VNC, 0xff00000000ff0000, 0xe700000000690000, // VECTOR AND WITH COMPLEMENT (VNC V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	...
	{VAVGL, 0xff00000000ff0000, 0xe700000000f00000, // VECTOR AVERAGE LOGICAL (VAVGL V1,V2,V3,M4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VBPERM, 0xff00000000ff0000, 0xe700000000850000, // VECTOR BIT PERMUTE (VBPERM V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	{VCKSM, 0xff00000000ff0000, 0xe700000000660000, // VECTOR CHECKSUM (VCKSM V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	...
	{VCLZ, 0xff00000000ff0000, 0xe700000000530000, // VECTOR COUNT LEADING ZEROS (VCLZ V1,V2,M3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VCTZ, 0xff00000000ff0000, 0xe700000000520000, // VECTOR COUNT TRAILING ZEROS (VCTZ V1,V2,M3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VDP, 0xff00000000ff0000, 0xe6000000007a0000, // VECTOR DIVIDE DECIMAL (VDP V1,V2,V3,I4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_28_35, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VEC, 0xff00000000ff0000, 0xe700000000db0000, // VECTOR ELEMENT COMPARE (VEC V1,V2,M3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VECL, 0xff00000000ff0000, 0xe700000000d90000, // VECTOR ELEMENT COMPARE LOGICAL (VECL V1,V2,M3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VERIM, 0xff00000000ff0000, 0xe700000000720000, // VECTORELEMENTROTATEANDINSERTUNDER MASK (VERIM V1,V2,V3,I4,M5)
	...
	{VESRLV, 0xff00000000ff0000, 0xe700000000780000, // VECTOR ELEMENT SHIFT RIGHT LOGICAL (VESRLV V1,V2,V3,M4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VX, 0xff00000000ff0000, 0xe7000000006d0000, // VECTOR EXCLUSIVE OR (VX V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	...
	{VFENE, 0xff00000000ff0000, 0xe700000000810000, // VECTOR FIND ELEMENT NOT EQUAL (VFENE V1,V2,V3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_Mask_32_35, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VFA, 0xff00000000ff0000, 0xe700000000e30000, // VECTOR FP ADD (VFA V1,V2,V3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_Mask_32_35, ap_Mask_28_31, ap_ImmUnsigned_36_39}},
	{WFK, 0xff00000000ff0000, 0xe700000000ca0000, // VECTOR FP COMPARE AND SIGNAL SCALAR (WFK V1,V2,M3,M4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_ImmUnsigned_36_39}},
	{VFCE, 0xff00000000ff0000, 0xe700000000e80000, // VECTOR FP COMPARE EQUAL (VFCE V1,V2,V3,M4,M5,M6)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VFCH, 0xff00000000ff0000, 0xe700000000eb0000, // VECTOR FP COMPARE HIGH (VFCH V1,V2,V3,M4,M5,M6)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VFCHE, 0xff00000000ff0000, 0xe700000000ea0000, // VECTOR FP COMPARE HIGH OR EQUAL (VFCHE V1,V2,V3,M4,M5,M6)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{WFC, 0xff00000000ff0000, 0xe700000000cb0000, // VECTOR FP COMPARE SCALAR (WFC V1,V2,M3,M4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_ImmUnsigned_36_39}},
	{VCLFNH, 0xff00000000ff0000, 0xe600000000560000, // VECTOR FP CONVERT AND LENGTHEN FROM NNP HIGH (VCLFNH V1,V2,M3,M4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_ImmUnsigned_36_39}},
	{VCLFNL, 0xff00000000ff0000, 0xe6000000005e0000, // VECTOR FP CONVERT AND LENGTHEN FROM NNP LOW (VCLFNL V1,V2,M3,M4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_ImmUnsigned_36_39}},
	{VCRNF, 0xff00000000ff0000, 0xe600000000750000, // VECTOR FP CONVERT AND ROUND TO NNP (VCRNF V1,V2,V3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_Mask_32_35, ap_Mask_28_31, ap_ImmUnsigned_36_39}},
	{VCFPS, 0xff00000000ff0000, 0xe700000000c30000, // VECTOR FP CONVERT FROM FIXED (VCFPS V1,V2,M3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VCDG, 0xff00000000ff0000, 0xe700000000c30000, // VECTOR FP CONVERT FROM FIXED 64-BIT (VCDG V1,V2,M3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VCFPL, 0xff00000000ff0000, 0xe700000000c10000, // VECTOR FP CONVERT FROM LOGICAL (VCFPL V1,V2,M3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VCDLG, 0xff00000000ff0000, 0xe700000000c10000, // VECTOR FP CONVERT FROM LOGICAL 64-BIT (VCDLG V1,V2,M3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VCFN, 0xff00000000ff0000, 0xe6000000005d0000, // VECTOR FP CONVERT FROM NNP (VCFN V1,V2,M3,M4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_ImmUnsigned_36_39}},
	{VCSFP, 0xff00000000ff0000, 0xe700000000c20000, // VECTOR FP CONVERT TO FIXED (VCSFP V1,V2,M3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VCGD, 0xff00000000ff0000, 0xe700000000c20000, // VECTOR FP CONVERT TO FIXED 64-BIT (VCGD V1,V2,M3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VCLFP, 0xff00000000ff0000, 0xe700000000c00000, // VECTOR FP CONVERT TO LOGICAL (VCLFP V1,V2,M3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VCLGD, 0xff00000000ff0000, 0xe700000000c00000, // VECTOR FP CONVERT TO LOGICAL 64-BIT (VCLGD V1,V2,M3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VCNF, 0xff00000000ff0000, 0xe600000000550000, // VECTOR FP CONVERT TO NNP (VCNF V1,V2,M3,M4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_ImmUnsigned_36_39}},
	{VFD, 0xff00000000ff0000, 0xe700000000e50000, // VECTOR FP DIVIDE (VFD V1,V2,V3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_Mask_32_35, ap_Mask_28_31, ap_ImmUnsigned_36_39}},
	{VFLL, 0xff00000000ff0000, 0xe700000000c40000, // VECTOR FP LOAD LENGTHENED (VFLL V1,V2,M3,M4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_ImmUnsigned_36_39}},
	{VFLR, 0xff00000000ff0000, 0xe700000000c50000, // VECTOR FP LOAD ROUNDED (VFLR V1,V2,M3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VFMAX, 0xff00000000ff0000, 0xe700000000ef0000, // VECTOR FP MAXIMUM (VFMAX V1,V2,V3,M4,M5,M6)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VFMIN, 0xff00000000ff0000, 0xe700000000ee0000, // VECTOR FP MINIMUM (VFMIN V1,V2,V3,M4,M5,M6)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VFM, 0xff00000000ff0000, 0xe700000000e70000, // VECTOR FP MULTIPLY (VFM V1,V2,V3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_Mask_32_35, ap_Mask_28_31, ap_ImmUnsigned_36_39}},
	...
	{VFNMS, 0xff00000000ff0000, 0xe7000000009e0000, // VECTOR FP NEGATIVE MULTIPLY AND SUBTRACT (VFNMS V1,V2,V3,V4,M5,M6)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_VecReg_32_35, ap_Mask_28_31, ap_Mask_20_23, ap_ImmUnsigned_36_39}},
	{VFPSO, 0xff00000000ff0000, 0xe700000000cc0000, // VECTOR FP PERFORM SIGN OPERATION (VFPSO V1,V2,M3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VFSQ, 0xff00000000ff0000, 0xe700000000ce0000, // VECTOR FP SQUARE ROOT (VFSQ V1,V2,M3,M4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_ImmUnsigned_36_39}},
	{VFS, 0xff00000000ff0000, 0xe700000000e20000, // VECTOR FP SUBTRACT (VFS V1,V2,V3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_Mask_32_35, ap_Mask_28_31, ap_ImmUnsigned_36_39}},
	...
	{VISTR, 0xff00000000ff0000, 0xe7000000005c0000, // VECTOR ISOLATE STRING (VISTR V1,V2,M3,M5)
	...
	{VLBR, 0xff00000000ff0000, 0xe600000000060000, // VECTOR LOAD BYTE REVERSED ELEMENTS (VLBR V1,D2(X2,B2),M3)
		[8]*argField{ap_VecReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VLC, 0xff00000000ff0000, 0xe700000000de0000, // VECTOR LOAD COMPLEMENT (VLC V1,V2,M3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	...
	{VLEG, 0xff00000000ff0000, 0xe700000000020000, // VECTOR LOAD ELEMENT (64) (VLEG V1,D2(X2,B2),M3)
		[8]*argField{ap_VecReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VLEB, 0xff00000000ff0000, 0xe700000000000000, // VECTOR LOAD ELEMENT (8) (VLEB V1,D2(X2,B2),M3)
		[8]*argField{ap_VecReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	...
	{VLER, 0xff00000000ff0000, 0xe600000000070000, // VECTOR LOAD ELEMENTS REVERSED (VLER V1,D2(X2,B2),M3)
		[8]*argField{ap_VecReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VFI, 0xff00000000ff0000, 0xe700000000c70000, // VECTOR LOAD FP INTEGER (VFI V1,V2,M3,M4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_Mask_28_31, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	...
	{VLM, 0xff00000000ff0000, 0xe700000000360000, // VECTOR LOAD MULTIPLE (VLM V1,V3,D2(B2),M4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_DispUnsigned_20_31, ap_BaseReg_16_19, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VLP, 0xff00000000ff0000, 0xe700000000df0000, // VECTOR LOAD POSITIVE (VLP V1,V2,M3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	...
	{VLBB, 0xff00000000ff0000, 0xe700000000070000, // VECTOR LOAD TO BLOCK BOUNDARY (VLBB V1,D2(X2,B2),M3)
		[8]*argField{ap_VecReg_8_11, ap_DispUnsigned_20_31, ap_IndexReg_12_15, ap_BaseReg_16_19, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VLVG, 0xff00000000ff0000, 0xe700000000220000, // VECTOR LOAD VR ELEMENT FROM GR (VLVG V1,R3,D2(B2),M4)
	...
	{VMO, 0xff00000000ff0000, 0xe700000000a70000, // VECTOR MULTIPLY ODD (VMO V1,V2,V3,M4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VMSL, 0xff00000000ff0000, 0xe700000000b80000, // VECTOR MULTIPLY SUM LOGICAL (VMSL V1,V2,V3,V4,M5,M6)
	...
	{VNN, 0xff00000000ff0000, 0xe7000000006e0000, // VECTOR NAND (VNN V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	{VNO, 0xff00000000ff0000, 0xe7000000006b0000, // VECTOR NOR (VNO V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	{VNX, 0xff00000000ff0000, 0xe7000000006c0000, // VECTOR NOT EXCLUSIVE OR (VNX V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	{VO, 0xff00000000ff0000, 0xe7000000006a0000, // VECTOR OR (VO V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	{VOC, 0xff00000000ff0000, 0xe7000000006f0000, // VECTOR OR WITH COMPLEMENT (VOC V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	...
	{VPERM, 0xff00000000ff0000, 0xe7000000008c0000, // VECTOR PERMUTE (VPERM V1,V2,V3,V4)
	...
	{VPDI, 0xff00000000ff0000, 0xe700000000840000, // VECTOR PERMUTE DOUBLEWORD IMMEDIATE (VPDI V1,V2,V3,M4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VPOPCT, 0xff00000000ff0000, 0xe700000000500000, // VECTOR POPULATION COUNT (VPOPCT V1,V2,M3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	...
	{VSCEG, 0xff00000000ff0000, 0xe7000000001a0000, // VECTOR SCATTER ELEMENT (64) (VSCEG V1,D2(V2,B2),M3)
		[8]*argField{ap_VecReg_8_11, ap_DispUnsigned_20_31, ap_VecReg_12_15, ap_BaseReg_16_19, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VSEL, 0xff00000000ff0000, 0xe7000000008d0000, // VECTOR SELECT (VSEL V1,V2,V3,V4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_VecReg_32_35, ap_ImmUnsigned_36_39}},
	...
	{VSRPR, 0xff00000000ff0000, 0xe600000000720000, // VECTOR SHIFT AND ROUND DECIMAL REGISTER (VSRPR V1,V2,V3,I4,M5)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_28_35, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VSL, 0xff00000000ff0000, 0xe700000000740000, // VECTOR SHIFT LEFT (VSL V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	{VSLB, 0xff00000000ff0000, 0xe700000000750000, // VECTOR SHIFT LEFT BY BYTE (VSLB V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	...
	{VSLDB, 0xff00000000ff0000, 0xe700000000770000, // VECTOR SHIFT LEFT DOUBLE BY BYTE (VSLDB V1,V2,V3,I4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_24_31, ap_ImmUnsigned_36_39}},
	{VSRA, 0xff00000000ff0000, 0xe7000000007e0000, // VECTOR SHIFT RIGHT ARITHMETIC (VSRA V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	{VSRAB, 0xff00000000ff0000, 0xe7000000007f0000, // VECTOR SHIFT RIGHT ARITHMETIC BY BYTE (VSRAB V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	{VSRD, 0xff00000000ff0000, 0xe700000000870000, // VECTOR SHIFT RIGHT DOUBLE BY BIT (VSRD V1,V2,V3,I4)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_24_31, ap_ImmUnsigned_36_39}},
	{VSRL, 0xff00000000ff0000, 0xe7000000007c0000, // VECTOR SHIFT RIGHT LOGICAL (VSRL V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	{VSRLB, 0xff00000000ff0000, 0xe7000000007d0000, // VECTOR SHIFT RIGHT LOGICAL BY BYTE (VSRLB V1,V2,V3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_ImmUnsigned_36_39}},
	{VSEG, 0xff00000000ff0000, 0xe7000000005f0000, // VECTOR SIGN EXTEND TO DOUBLEWORD (VSEG V1,V2,M3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	...
	{VSTL, 0xff00000000ff0000, 0xe7000000003f0000, // VECTOR STORE WITH LENGTH (VSTL V1,R3,D2(B2))
		[8]*argField{ap_VecReg_8_11, ap_Reg_12_15, ap_DispUnsigned_20_31, ap_BaseReg_16_19, ap_ImmUnsigned_36_39}},
	{VSTRC, 0xff00000000ff0000, 0xe7000000008a0000, // VECTOR STRING RANGE COMPARE (VSTRC V1,V2,V3,V4,M5,M6)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_VecReg_32_35, ap_Mask_20_23, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	{VSTRS, 0xff00000000ff0000, 0xe7000000008b0000, // VECTOR STRING SEARCH (VSTRS V1,V2,V3,V4,M5,M6)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_VecReg_16_19, ap_VecReg_32_35, ap_Mask_20_23, ap_Mask_24_27, ap_ImmUnsigned_36_39}},
	...
	{VTM, 0xff00000000ff0000, 0xe700000000d80000, // VECTOR TEST UNDER MASK (VTM V1,V2)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_ImmUnsigned_36_39}},
	{VUPH, 0xff00000000ff0000, 0xe700000000d70000, // VECTOR UNPACK HIGH (VUPH V1,V2,M3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VUPLH, 0xff00000000ff0000, 0xe700000000d50000, // VECTOR UNPACK LOGICAL HIGH (VUPLH V1,V2,M3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VUPLL, 0xff00000000ff0000, 0xe700000000d40000, // VECTOR UNPACK LOGICAL LOW (VUPLL V1,V2,M3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
	{VUPL, 0xff00000000ff0000, 0xe700000000d60000, // VECTOR UNPACK LOW (VUPL V1,V2,M3)
		[8]*argField{ap_VecReg_8_11, ap_VecReg_12_15, ap_Mask_32_35, ap_ImmUnsigned_36_39}},
